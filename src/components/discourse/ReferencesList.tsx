...
export const ReferencesList: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-3.5 pt-3.5 border-t border-[#24354d] text-[#f8fafc]">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1 font-mono text-[10.5px] uppercase tracking-wider text-[#38bdf8] hover:underline disabled:opacity-30"
        >
          {isGeneratingReferences ? (
      ...
      {references.length === 0 ? (
        <div className="p-4 bg-[#162234] border border-[#24354d] rounded-sm text-center">
          <BookOpen className="w-6 h-6 text-[#64748b] mx-auto mb-2 opacity-70" />
        ...
        <div className="flex flex-col gap-2.5">
          {references.map((ref, idx) => (
            <div
              key={idx}
              className="p-3 bg-[#162234] border border-[#24354d] rounded-sm flex flex-col gap-1.5 shadow-xs"
            >
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="font-serif italic font-bold text-[15px] text-[#f8fafc]">
                    {ref.obra}
                  </h4>
